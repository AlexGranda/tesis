...
svm = SVC(kernel='poly', probability=True, random_state=42, gamma='auto')
...
ax.set(xticks=np.arange(cm.shape[1]), yticks=np.arange(cm.shape[0]),
           ...
           title="Linear SVM Confusion matrix using KMeans",
...
fig.tight_layout()
plt.savefig("SVM_KMeans_CM_kernel_lineal.jpg")
...
print("Testing...")
test_predictions = svm.predict(kmeans)
